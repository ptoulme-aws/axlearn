...
sudo apt-get remove -y --allow-change-held-packages aws-neuronx-devtools || true
...
sudo dpkg -i /shared_new/ptoulme/axlearn/aws-neuronx-runtime-lib-2.x.12506.0-0cb6bb7f6.deb
sudo dpkg -i /shared_new/ptoulme/axlearn/aws-neuronx-collectives-2.x.13284.0-c992498f7.deb
